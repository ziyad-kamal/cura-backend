...
export const jwtVerify = async (req, res, next) => {
    ...
    const accessToken = (authHeader === null || authHeader === void 0 ? void 0 : authHeader.startsWith("Bearer ")) ? authHeader.split(" ")[1] : undefined;
    ...
    try {
        ...
        if (jwtError.name === "TokenExpiredError") {
            ...
            try {
                const userData = jwt.verify(refreshToken, jwtConfig.refreshTokenSecret);
                const newAccessToken = jwt.sign({ _id: userData._id, email: userData.email, role: userData.role }, jwtConfig.accessTokenSecret, {
