...
export const indexVendorsService = async (req) => {
    return await Vendor.find({ isActive: true });
};
export const createVendorService = async (req) => {
    var _a;
...
export const showVendorService = async (req) => {
    return await Vendor.findById(req.params.id);
};
export const getVendorByUserIdService = async (req) => {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
...
export const updateVendorService = async (req) => {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
    const vendor = await Vendor.findOne({ userId });
    if (!vendor) {
...
export const deleteVendorService = async (req) => {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
    const vendor = await Vendor.findOne({ userId });
    if (!vendor) {
...
export const getVendorDashboardStatsService = async (req) => {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
    const vendor = await Vendor.findOne({ userId });
    if (!vendor) {
...
export const getVendorProductsService = async (req) => {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
    const vendor = await Vendor.findOne({ userId });
    if (!vendor) {
...
export const getVendorOrdersService = async (req) => {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
    const vendor = await Vendor.findOne({ userId });
    if (!vendor) {
...
export const updateVendorOrderItemStatusService = async (req) => {
    var _a;
    const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
    const vendor = await Vendor.findOne({ userId });
    if (!vendor) {
