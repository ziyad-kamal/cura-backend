...
const generateFakeUser = (role = UserRoles.USER) => {
    ...
    return Object.assign(Object.assign({ name: {
            ...
            address: { city, street },
        }, password: HASHED_PASSWORD, isVerified: true, isActive: faker.datatype.boolean({ probability: 0.9 }) }, (isDoctor && {
        doctorInfo: {
            ...
            workingDays: faker.helpers.arrayElements(["Saturday", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday"], { min: 3, max: 6 }),
        ...
        }, role, image: DEFAULT_IMAGE, coverImage: DEFAULT_IMAGE, provider: "local" });
};
export const seedUsers = async (count = 30) => {
    try {
