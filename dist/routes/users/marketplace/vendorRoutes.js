...
import { destroy, index, show, store, update, myStore, dashboard, myProducts, myOrders, updateMyOrderItemStatus, } from "../../../app/controllers/vendors/vendorController.js";
...
router.patch("/me/orders/:orderId/items/:itemId/status", jwtVerify, requireRole(UserRoles.VENDOR), updateMyOrderItemStatus);
